namespace MAS.Payments.Commands
{
    ...
    public class AddUserNotificationCommandHandler : BaseCommandHandler<AddUserNotificationCommand>
    {
        ...
        public override async Task HandleAsync(AddUserNotificationCommand command)
        {
            ...
            var hasDuplicateKeys = await Repository.Any(new UserNotificationSpec.IsKeyIn(notificationKeys));
            ...
            await Repository.AddRange(command.UserNotifications);
        }
    }
}
